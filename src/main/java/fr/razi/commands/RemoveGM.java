...
public class RemoveGM implements CommandExecutor {

    private final SingleGivePerm instance;

    public RemoveGM(SingleGivePerm instance){
    ...
    public boolean onCommand( CommandSender sender, Command command, String label, String[] args) {
        ...
        if(sender instanceof Player){
            ...
            String usage = "§c/removegm <TargetPlayer>";
            ...
            if(targetPlayer == null){
                ...
                PermissionManager.setIGGameModePermission(targetPlayer, instance, false);
                PermissionManager.setPermGMOnConfig(targetPlayer.getUniqueId(), instance, false);
